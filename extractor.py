...
BENCHMARK_RESULT = "extracted_benchmark_result.csv"
...
if __name__ == "__main__":
    ...
    while simulations:
        ...
        for current_run in range(NUM_RUN):
            ...
            # Check if the trace file exist
            if not os.path.isfile(PATH_TO_RESULT_TRACY_FILE):
                print("ERROR: this trace file: " + PATH_TO_RESULT_TRACY_FILE + "doesn't exist")
            ...
            process_csv_extractor = subprocess.Popen(command, shell=True)
